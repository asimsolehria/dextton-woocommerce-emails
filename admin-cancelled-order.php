...
<tr>
	<td style="font-family:Geogrotesque,Arial,Verdana,Helvetica,sans-serif;color:#2f3132;font-size:16px;line-height:20px" valign="top" align="center">
		Notification to let you know — order #<?php echo $order->get_id() ?> <br> <br> belonging to <?php echo $order->get_billing_first_name() ?> <?php echo $order->get_billing_last_name() ?> has been cancelled!
	</td>
</tr>
</tbody>
</table>
