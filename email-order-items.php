...
?>
	...
	<tr>
		...
		<td style="font-size:12px;width:112" width="13%" align="center">
			<table>
				<tbody>
					<tr>
		...
		<td style="font-size:12px;width:20" width="8%" align="center">
		</td>
		<td style="font-size:12px" width="14%" align="right">
	...
	?>
		<tr>
			<td colspan="5" style="text-align:left; vertical-align:middle; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">
				<?php
